...
import com.excel.common.StringUtils;
...
import com.excel.repository.DescribeRepository;
...
public class DownloadService {
	...
	public List<DescribeXlsxDto> downloadResource(DescribeFilterDto describeFilterDto) {
		...
		return describeEntityList.stream().map(DescribeXlsxDto::of).toList();
	}
	...
	public List<MemberXlsxDto> downloadMember(MemberFilterDto memberFilterDto) {
